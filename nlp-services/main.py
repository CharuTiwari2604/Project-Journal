...
#     # Keywords for deeper context
#     keywords = {
#         "stress": ["pressure", "overwhelmed", "deadline", "burnout", "stress"],
#         "relationship": ["relationship", "connection", "partner", "friend", "family"],
#         "loneliness": ["alone", "isolated", "lonely"],
#         "motivation": ["motivated", "inspired", "determined", "drive"],
#         "tiredness": ["tired", "exhausted", "fatigued", "drained"],
#     }

#     # Base feedback from emotion
#     feedback_map = {
#         "anger": "You seem frustrated. Try venting through writing or taking a short break.",
#         "frustration": "You seem frustrated. Try venting through writing or taking a short break.",
#         "sadness": "It sounds like you’re feeling low today. Give yourself permission to rest and process your emotions.",
#         "grief": "You’re carrying some heavy emotions — remember it’s okay to ask for support.",
#         "joy": "You're feeling joyful — keep doing what brings you happiness!",
#         "love": "You're radiating love. Spread it around!",
#         "fear": "Feeling fear or anxiety? Try grounding yourself with deep breaths.",
#         "surprise": "You seem surprised. Reflecting can help understand what triggered this feeling."
#     }

#     feedback = feedback_map.get(emotion, "Keep writing, your thoughts matter.")

#     # Add personalised note if keywords are found
#     for category, words in keywords.items():
#         if any(word in clean_text for word in words):
#             if category == "stress":
#                 feedback += " It sounds like you’ve been under a lot of pressure lately — maybe break tasks into smaller steps."
#             elif category == "relationship":
#                 feedback += " Your reflections on relationships show they matter deeply to you — consider reaching out again when the moment feels right."
#             elif category == "loneliness":
#                 feedback += " It seems like you’re feeling disconnected — even a brief chat with someone could help."
#             elif category == "motivation":
#                 feedback += " I can sense your drive — channel it into something you love."
#             elif category == "tiredness":
#                 feedback += " Your body and mind might need some rest — listen to that signal."
#             break  # Only add one personalised category at a time
...
#     # Simple name detection using capital letters (tuned for English)
...
#     # Add name-based personalized insight
#     names = extract_names(journal_text)
#     if names:
#         for name in names:
#             if name.lower() not in ["i", "you", "my"]:  # Avoid false positives
#                 feedback += f" It seems like you're thinking a lot about {name}. Are they someone important to you?"
#                 feedback += f" Your emotions might be closely tied to your connection with {name}."
#                 break  # Only respond to the first name found

#     # Add category-based contextual feedback
#     for category, words in keywords.items():
#         if any(word in clean_text for word in words):
#             if category == "stress":
#                 feedback += " It sounds like you’ve been under a lot of pressure lately — maybe break tasks into smaller steps."
...
#             elif category == "tiredness":
#                 feedback += " Your body and mind might need some rest — listen to that signal."
#             break  # Only add one category at a time
